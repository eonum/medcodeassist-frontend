class ApplicationController < ActionController::Base
  ...
  def get_words
    ...
    parsed_tokens.map {|x| x['word']}
  end

  def get_mocked_words
    %w(hodgkin mellitus insipidus laparotomie test)
  end
  ...
  def get_code_proposals
    ...
    JSON.parse(code_proposals.body)
  end
  ...
  def get_mocked_suggested_related_codes
    ...
    {mainDiagnoses: main_related_codes, sideDiagnoses: side_related_codes, procedures: procedure_related_codes}
  end
