...
<<<<<<< HEAD
=======
- At first use, load data in your local database to make the search work. To do this, put your data in 'test/testdata'. Then open a terminal and cd to the project. Type `rake db:seed_test_data`
>>>>>>> development
